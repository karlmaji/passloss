...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 1060, 674))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 1507, 594))
        ...
        spacerItem64 = QtWidgets.QSpacerItem(18, 28, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.verticalLayout_7.setStretch(6, 50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "d1 发射机到对流层的距离(km)"))
        self.label_12.setText(_translate("MainWindow", "d2 对流层到接收端的距离(km)"))
        ...
        self.label_18.setText(_translate("MainWindow", "ht 发送机海平面平均值以上的高度（km"))
        self.label_22.setText(_translate("MainWindow", "hr 接收机海平面平均值以上的高度（km"))
        ...
        self.label_33.setText(_translate("MainWindow", "y10-Lah 作图"))
        self.label_34.setText(_translate("MainWindow", "（hte/波长）-Lbr作图"))
        # self.label_35.setText(_translate("MainWindow", "图像显示区"))
        # self.label_36.setText(_translate("MainWindow", "图像显示区"))
        self.label_37.setText(_translate("MainWindow", "p-Lbs1 作图"))
        self.label_38.setText(_translate("MainWindow", "d-Ln 作图"))
        # self.label_39.setText(_translate("MainWindow", "图像显示区"))
        # self.label_40.setText(_translate("MainWindow", "图像显示区"))
